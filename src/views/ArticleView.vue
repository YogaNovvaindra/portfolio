      ...
      >
        ...
        <button
          ...
          :class="showShare
            ...
            : 'border-zinc-800 bg-zinc-900/80 text-zinc-500 hover:text-zinc-200 hover:border-zinc-600 backdrop-blur-sm'"
        >
          ...
          <div v-if="showShare" class="flex flex-col items-center gap-2">
            ...
            <button
              ...
              :class="copied
                ...
                : 'border-zinc-800 bg-zinc-900/80 text-zinc-500 hover:text-white hover:border-zinc-600 backdrop-blur-sm'"
            >
            ...
            <a :href="`https://wa.me/?text=${encodeURIComponent(shareText + ' ' + shareUrl)}`"
              ...
              class="w-9 h-9 rounded-full flex items-center justify-center border border-zinc-800 bg-zinc-900/80 text-zinc-500 hover:text-emerald-400 hover:border-emerald-500/40 backdrop-blur-sm transition-all duration-200">
            ...
            <a :href="`https://t.me/share/url?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent(shareText)}`"
              ...
              class="w-9 h-9 rounded-full flex items-center justify-center border border-zinc-800 bg-zinc-900/80 text-zinc-500 hover:text-sky-400 hover:border-sky-500/40 backdrop-blur-sm transition-all duration-200">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}&url=${encodeURIComponent(shareUrl)}`"
              ...
              class="w-9 h-9 rounded-full flex items-center justify-center border border-zinc-800 bg-zinc-900/80 text-zinc-500 hover:text-white hover:border-zinc-500 backdrop-blur-sm transition-all duration-200">
            ...
            <a :href="`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(shareUrl)}`"
              ...
              class="w-9 h-9 rounded-full flex items-center justify-center border border-zinc-800 bg-zinc-900/80 text-zinc-500 hover:text-blue-400 hover:border-blue-500/40 backdrop-blur-sm transition-all duration-200">
            ...
            <a :href="`https://reddit.com/submit?url=${encodeURIComponent(shareUrl)}&title=${encodeURIComponent(shareText)}`"
              ...
              class="w-9 h-9 rounded-full flex items-center justify-center border border-zinc-800 bg-zinc-900/80 text-zinc-500 hover:text-orange-400 hover:border-orange-500/40 backdrop-blur-sm transition-all duration-200">
