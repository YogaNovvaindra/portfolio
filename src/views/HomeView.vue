  ...
  <main
    ...
    <div class="flex flex-col flex-1 space-y-2 text-center md:text-left px-10">
      ...
      <div class="mt-auto pt-8 fade-in-links">
        <div class="flex space-x-4 justify-center md:justify-start">
          <a href="mailto:yoganovaindra@gmail.com" target="_blank" rel="noopener noreferrer" class="text-white hover:text-blue-300 transition-colors">
          ...
          <a href="https://linkedin.com/in/yoga-novaindra" target="_blank" rel="noopener noreferrer" class="text-white hover:text-blue-300 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
              <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
            </svg>
          </a>
          <a href="https://github.com/yoganovvaindra" target="_blank" rel="noopener noreferrer" class="text-white hover:text-blue-300 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
    ...
    <div class="flex justify-center md:justify-start fadein-right">
      <img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-blue-300 pict" src="/img/avatar.png" />
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["DevOps Engineer", "Back End Engineer", "Tech Enthusiast", "Homelaber"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
